 ...
 export default class MyComponent extends Component{
     constructor(props){
       ...
       this.tabArr=[{text:'首页',key:'mainpage',url:'/mainpage',index:0,activeElement:true},
        ...
        this.imgTabArr4=[
               {imgPath:require('../../images/help/help1.png'),title:'云管理平台配置讲解视频教程',desc:'',videoName:'01K3WISE云管理平台配置讲解视频教程.mp4',
               ...
               {imgPath:require('../../images/help/help2.png'),title:'轻应用待办消息配置视频教程',desc:'',videoName:'02K3WISE轻应用待办消息配置视频教程.mp4',
               render:()=><div className='help-vidiu'><span><img src={require('../../images/help/clock.png')}/>2016-08-05</span><span><img src={require('../../images/help/eye.png')}/>168</span></div>
               },
               {imgPath:require('../../images/help/help3.png'),title:'轻应用移动审批配置视频教程',desc:'', videoName:'03K3WISE轻应用移动审批配置视频教程.mp4',
               render:()=><div className='help-vidiu'><span><img src={require('../../images/help/clock.png')}/>2016-08-05</span><span><img src={require('../../images/help/eye.png')}/>168</span></div>},
               {imgPath:require('../../images/help/help4.png'),title:'轻应用移动报销配置视频教程',desc:'',videoName:'04K3WISE轻应用移动报销配置视频教程.mp4',
               render:()=><div className='help-vidiu'><span><img src={require('../../images/help/clock.png')}/>2016-08-05</span><span><img src={require('../../images/help/eye.png')}/>168</span></div>},
          ]
        this.imgTabArr5=[
               {imgPath:require('../../images/help/help5.png'),title:'轻应用移动下单配置视频教程',desc:'',videoName:'05K3WISE轻应用移动下单配置视频教程.mp4',
               render:()=><div className='help-vidiu'><span><img src={require('../../images/help/clock.png')}/>2016-08-05</span><span><img src={require('../../images/help/eye.png')}/>168</span></div>},
               {imgPath:require('../../images/help/help6.png'),title:'轻应用订单跟踪配置视频教程',desc:'',videoName:'06K3WISE轻应用订单跟踪配置视频教程.mp4',
               render:()=><div className='help-vidiu'><span><img src={require('../../images/help/clock.png')}/>2016-08-05</span><span><img src={require('../../images/help/eye.png')}/>168</span></div>},
               {imgPath:require('../../images/help/help3.png'),title:'轻应用应收款管理配置视频教程',desc:'',videoName:'07K3WISE轻应用应收款管理配置视频教程.mp4',
               render:()=><div className='help-vidiu'><span><img src={require('../../images/help/clock.png')}/>2016-08-05</span><span><img src={require('../../images/help/eye.png')}/>168</span></div>},
               {imgPath:'',title:'',desc:''},
          ]
     }
     ...
     render(){
        return (
           <div className="container">
              ...
              <ImgText dataSource={this.imgTabArr} layout={'row'} className='help-imgtext-pdf' mouseover={this.handleMouseOver} mouseout={this.handleMouseout} imgTextClick={this.handleImgTextClick} />
              <ImgText dataSource={this.imgTabArr2} layout={'row'} className='help-imgtext-pdf' mouseover={this.handleMouseOver} mouseout={this.handleMouseout} imgTextClick={this.handleImgTextClick}/>
              <div className='help-title-one'>
                 <div>常见问题</div>
              </div>
              <ImgText dataSource={this.imgTabArr3} layout={'row'} className='help-imgtext-pdf' mouseover={this.handleMouseOver} mouseout={this.handleMouseout} imgTextClick={this.handleImgTextClick}/>
              <div className='help-title-one'>
                <div>视频资料</div>
              </div>
              <ImgText dataSource={this.imgTabArr4} layout={'column'} className={'help-imgtext-vedio'} imgTextClick={this.handleVideoPlay} />
              <ImgText dataSource={this.imgTabArr5} layout={'column'} className={'help-imgtext-vedio'} maskerRender={this.handleMaskerRender} imgTextClick={this.handleVideoPlay}/>
           </div>
        )
     }
 }
